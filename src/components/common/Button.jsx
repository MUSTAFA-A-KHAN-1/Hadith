...
const Button = forwardRef(({
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary-light focus:ring-primary dark:bg-primary-500 dark:hover:bg-primary-400',
    secondary: 'border-2 border-primary text-primary hover:bg-primary hover:text-white focus:ring-primary dark:border-primary-400 dark:text-primary-400',
